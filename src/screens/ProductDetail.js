        ...
        <div id="product-head" class="row">
          ...
          <div id="product-details" class="col-lg-6 col-md-6 col-sm-12">
            ...
            <ul>
              ...
              <li><span>Đi kèm:</span> {detail?.accessories}</li>
              <li><span>Tình trạng:</span> {detail?.status}</li>
              <li><span>Khuyến Mại:</span> {detail?.promotion}</li>
              <li id="price">Giá Bán (chưa bao gồm VAT)</li>
              <li id="price-number">{detail?.price}đ</li>
              <li id="status">{detail?.is_stock ? 'Còn hàng' : 'Hết hàng'}</li>
            </ul>
